...
export function GridWrapper({ children, className }: GridWrapperProps) {
  return (
    ...
    >
      ...
      >
        <div className="pointer-events-none absolute bottom-[-5px] right-[-5px] z-2 flex size-2.5 items-center justify-center border border-neutral-300 bg-white shadow-xs"></div>
      </div>
      {children}
      <div
        aria-hidden="true"
