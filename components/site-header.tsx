...
export function SiteHeader() {
  return (
    <header
      className="fixed inset-x-0 top-8 z-20 mx-auto grid h-[52px] w-[342px] grid-cols-2 items-center justify-between gap-x-7 rounded-full border border-black/[0.08] bg-white/[0.85] px-[10px] shadow-[inset_0_0_1px_0_rgba(0,0,0,.05)] dark:border-white/[0.18] dark:bg-black/80 dark:shadow-[inset_0_0_1px_0_rgba(235,235,255,.1)] sm:grid md:w-full md:max-w-2xl md:grid-cols-3"
      style={{
    ...
    >
      <div className="flex h-full items-center justify-start">
        <Link href="/">
          <Icons.logo className="ml-1.5 h-[17.5px] w-auto" />
        </Link>
      </div>
